...
ORDER BY
  CASE
    WHEN 채널명 = '스타뱅킹' AND 영향요인 = '로그인/인증' THEN 1
    WHEN 채널명 = '스타뱅킹' AND 영향요인 = '홈화면' THEN 2
    WHEN 채널명 = '스타뱅킹' AND 영향요인 = '계좌조회/이체' THEN 3
    WHEN 채널명 = '스타뱅킹' AND 영향요인 = '통합검색' THEN 4
    WHEN 채널명 = '스타뱅킹' AND 영향요인 = '금융상품몰' THEN 5
    WHEN 채널명 = '스타뱅킹' AND 영향요인 = '상품가입' THEN 6
    WHEN 채널명 = '스타뱅킹' AND 영향요인 = '상품관리/해지' THEN 7
    WHEN 채널명 = '스타뱅킹' AND 영향요인 = '콘텐츠/서비스' THEN 8
    WHEN 채널명 = '영업점' AND 영향요인 = '내점/방문' THEN 9
    WHEN 채널명 = '영업점' AND 영향요인 = '대기' THEN 10
    WHEN 채널명 = '영업점' AND 영향요인 = '맞이/의도파악' THEN 11
    WHEN 채널명 = '영업점' AND 영향요인 = '직원상담' THEN 12
    WHEN 채널명 = '영업점' AND 영향요인 = '업무처리/배웅' THEN 13
    WHEN 채널명 = '고객센터' AND 영향요인 = '버튼식ARS' THEN 14
    WHEN 채널명 = '고객센터' AND 영향요인 = '보이는ARS' THEN 15
    WHEN 채널명 = '고객센터' AND 영향요인 = '대기' THEN 16
    WHEN 채널명 = '고객센터' AND 영향요인 = '챗봇상담' THEN 17
    WHEN 채널명 = '고객센터' AND 영향요인 = '콜봇상담' THEN 18
    WHEN 채널명 = '고객센터' AND 영향요인 = '직원상담' THEN 19
    WHEN 채널명 = '상품' AND 영향요인 = '저축성' THEN 20
    WHEN 채널명 = '상품' AND 영향요인 = '여신성' THEN 21
    WHEN 채널명 = '상품' AND 영향요인 = '투자성' THEN 22
    WHEN 채널명 = '상품' AND 영향요인 = '보장성' THEN 23
    WHEN 채널명 = '상품' AND 영향요인 = '외화환전' THEN 24
    WHEN 채널명 = '상품' AND 영향요인 = '해외송금' THEN 25
  END