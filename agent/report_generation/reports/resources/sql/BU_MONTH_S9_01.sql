WITH A AS (
    ...
    SELECT
        ...
        , CASE
          ...
          END AS 부서명
        , CASE
            WHEN 채널='영업점' AND B.그룹내용 != '영업기획그룹' THEN '기타'
            ELSE B.그룹내용
          END AS 그룹명
...
ORDER BY
  CASE
    WHEN 채널 = '종합'        AND 그룹명 = '합계' THEN 1
    WHEN 채널 = 'KB 스타뱅킹' AND 그룹명 = '합계' THEN 2
    WHEN 채널 = 'KB 스타뱅킹' AND 그룹명 = '디지털영업그룹' THEN 3
    WHEN 채널 = 'KB 스타뱅킹' AND 그룹명 = '개인고객그룹' THEN 4
    WHEN 채널 = 'KB 스타뱅킹' AND 그룹명 = 'WM고객그룹' THEN 5
    WHEN 채널 = 'KB 스타뱅킹' AND 그룹명 = '기업고객그룹' THEN 6
    WHEN 채널 = '영업점'      AND 그룹명 = '합계' THEN 7
    WHEN 채널 = '영업점'      AND 그룹명 = '영업기획그룹' THEN 8
    WHEN 채널 = '영업점'      AND 그룹명 = '기타' THEN 9
    WHEN 채널 = '고객센터'    AND 그룹명 = '합계' THEN 10
    WHEN 채널 = '고객센터'    AND 그룹명 = '고객컨택영업그룹' THEN 11
    WHEN 채널 = '상품'        AND 그룹명 = '합계' THEN 12
    WHEN 채널 = '상품'        AND 그룹명 = '개인고객그룹' THEN 13
    WHEN 채널 = '상품'        AND 그룹명 = 'WM고객그룹' THEN 14
    WHEN 채널 = '상품'        AND 그룹명 = '기업고객그룹' THEN 15
  END