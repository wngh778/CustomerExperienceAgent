...
class Settings(BaseSettings):
    ...
    if os.getenv("ENV_PATH") != "serving":
        if ENV == "stg":
            ...
            AZURE_OPENAI_ENDPOINT: str = "https://cm-hea-genai-prd-apim.azure-api.net/trnn/"
    else:
        if ENV == "stg":
            ...
            AZURE_OPENAI_API_KEY: str = "b8ba5529379d403c946699cc18bb0b82"
            AZURE_OPENAI_ENDPOINT: str = "https://cm-hea-genai-prd-apim.azure-api.net/serv/"
